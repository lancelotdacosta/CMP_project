...
#- cell count data (raw)
#- anatomical data
#- sampling period (7 by default): number of days after last sample at which to add anatomical data


#function
add.anat.data <- function(cc.data, anat.data, sampling_period =7){
